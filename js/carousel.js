...
document.addEventListener("DOMContentLoaded", function () {
    const products = [
        { img: "../img/products/med_v_sotah.jpg", price: "112 MDL", descr: "Miere în fagure", data_art: "7" },
        { img: "../img/products/multifloral.png", price: "149 MDL", descr: "Miere multifloral", data_art: "2" },
        { img: "../img/products/propolis.jpg", price: "89 MDL", descr: "Propolos", data_art: "6" },
        { img: "../img/products/vax.jpg", price: "71 MDL", descr: "Ceară de albine", data_art: "5" },
        { img: "../img/products/pollen.png", price: "124 MDL", descr: "Pollen", data_art: "3" },
        { img: "../img/products/lipoviy_med.png", price: "100 MDL", descr: "Miere de tei", data_art: "1" }
    ];
        ...
        return `
            <div class="col col-flex-my">
                <div class="product-item">
                    ...
                    <div class="button-add"><button id="add-to-cart" data=${product.data_art} class="add-to-cart">Cumpara</button></div>
