    ...
    function showCart() {
        ...
        function comanda() {
            if (!$.isEmptyObject(cart)) { 
                ...
                out2 += '<a href="../comanda-ro.html" class="main_block__button_red2">Face o comanda</a>';
                out2 += '</div>';
                ...
                out2 +=' <p>Voi n-ați selectat nici un bun<br>';
                out2 +='  Puteți să select aici<br><br>';
                out2 +='  <a href="Produsele-ro2.html" class="main_block__button_red2">Merge</a>';
                out2 +='  </div>';
                out2 +='</div>';
                out2 +='</div>';
