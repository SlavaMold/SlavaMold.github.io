    ...
    function showCart() {
        ...
        function comanda_ru() {
            if (!$.isEmptyObject(cart)) { 
                ...
                out2 += '<a href="../comanda-ru.html" class="main_block__button_red2">Оформить заказ</a>';
                out2 += '</div>';

            }
            else{
                 var out2 = '';
                 out2 +='<div class="center">';
                out2 +='<div class="hidden_block1">';
                out2 +='<div class="header-block"><br><br>';
                out2 +=' <p>Вы не выбрали ни одного товара<br>';
                out2 +='  Вы можете выбрать товар здесь<br><br>';
                out2 +='  <a href="Produsele-ru2.html" class="main_block__button_red2">Перейти</a>';
                out2 +='  </div>';
                out2 +='</div>';
                out2 +='</div>';  
            }
