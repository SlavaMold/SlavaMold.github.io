                        ...
                        $.ajax({
                                ...
                                $('.toModal').html(`
                                    <div class="modal">
                                        <div class="modal-vindow">
                                            <h3 class="modal-text">Prelucram datele...</h3>
                                        </div>
                            ...
                            success: function (data2) {
                                if (data2.status === 'ok') {
                                    ...
                                    alert('Nu s-a încărcat comanda dvs. , vă rugăm să încercați din nou!');
                                }
                            },
                            error: function () {
                                alert('Eroare la comunicarea cu serverul. Vă rugăm să încercați din nou mai târziu.');
                            }
                        });
                ...
                for (let i = 0; i < lengt.length; i++) {
                    if (!isNaN(parseFloat(lengt[i])) && isFinite(lengt[i])) {
                        ...
                        if (lengt[i] == '+' || lengt[i] == ')' || lengt[i] == '(' || lengt[i] == '-') {
                            ...
                            formAddError(input);
                            alert('Numărul de telefon a fost introdus incorect!');
                            outerror = 1;
                            return outerror;
                        }
                    }
