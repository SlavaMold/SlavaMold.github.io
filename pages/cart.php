...
<header class="header-dop">
        <div class="container">
            <div class="header-line">
                <div class="header-logo">
                    <a href='../index-ru.php'><img src="../img/logo.png" class="header-logo-img"></a>
                </div>

                <div class="navigate">
                    <a class="nav-item" href="../index-ru.php">ГЛАВНАЯ</a>
                    <a class="nav-item" href="../index-ru.php#whoUs">О НАС</a>
                    <a class="nav-item" href="../index-ru.php#production">ПОПУЛЯРНЫЕ ПРОДУКТЫ</a>
                    <a class="nav-item" href="#cont">КОНТАКТЫ</a>
                    <div class="dropdown nav-item">
                        <a class="dropdown-chose" href="#">ru <button class="drop-activator"> <img class="dropdown-img" src="../img/main-page/icons/caret-down.png"> </button></a> 
                            <div class="dropdown-content">     
                              <a class="dropdown-chose" href="cart-ro.php">ro</a>
                            </div>
                    </div>
                </div>
                ...
                <div class="phone">
                    ...
                    <div class="phone-hold">
                        ...
                        <span class="phone-txt">Номер для связи <br>с администрацией</span>
                    </div>
                </div>

                <div class="batn"> <a href="about-page.html" class="button">ВЫБРАТЬ УСЛУГИ</a>
                </div>
        ...
        <div class="container">
            <div class="burger-slide active" id="menu-slide">
                <div class="burger-hold other-hold">
                    <a class="nav-item hidd" href="../index-ru.php#">ГЛАВНАЯ</a>
                    <a class="nav-item hidd" href="../index-ru.php#whoUs">О НАС</a>
                    <a class="nav-item hidd" href="../index-ru.php#production">ПОПУЛЯРНЫЕ ПРОДУКТЫ</a>
                    <a class="nav-item hidd" href="../index-ru.php#cont">КОНТАКТЫ</a>
                    <a class="nav-item hidd" href="#">ru</a>
                    <a class="nav-item hidd" href="cart-ro.php">ro</a>
            ...
            <div class="take-a-order">
                <div class="forma">
                    <form name="haisenberg" action="?" method="POST" class="form-body" id="form"
                        ...
                        <div class="notificat">
                        Внимание! В случае неверного заполнения формы ваш заказ не будет обработан!
                        </div>
                        ...
                        <div class="form-item">
                            <label class="form-label" for="formNumber">Номер телефона*</label>
                        ...
                        <div class="form-item">
                            <div class="form-label"> Желаете доставку? </div>
                            <div class="options">
                                <div class="options-item">
                                    <input id="formOrdered" type="radio" checked value="ordered" name="ord"
                                        class="options-input">
                                    <label class="options-label" for="formOrdered"><span>С доставкой (+150
                                            MDL)</span></label>
                                </div>
                                ...
                                <div class="options-item">
                                    <input id="formNoOrdered" type="radio" value="noordered" name="ord"
                                        class="options-input">
                                    <label class="options-label" for="formNoOrdered"><span>Без доставки</span></label>
                                </div>
                        ...
                        <div class="form-item">
                            <label class="form-label" for="formMessage">Комментарий к заказу</label>
                        ...
                        <!-- <div class="form-item">
                            ...
                            <div class="file">
                                <div class="file-item">
                                    ...
                                    <input id="formImage" accept=".jpeg, .jpg, .png, .svg, .bmp" name="image" type="file"
                                        class="file-input req" multiple>
                        ...
                        <div class="accept-block">
                            ...
                            <label class="form-label acc-text" for="Accept">Я даю согласие на обработку и хранение 
                               персональных данных из этой формы.
                            </label>
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        <nav class="footer-nav d-flex flex-column">
                            <a class="text-light mb-2" href="../index-ru.php">ГЛАВНАЯ</a>
                            <a class="text-light mb-2" href="../index-ru.php#whoUs">О НАС</a>
                            <a class="text-light mb-2" href="../index-ru.php#production">ПРОДУКЦИЯ</a>
                        </nav>
                    </div>
                </div>
                <div class="copyright">
    ...
    <script src="../js/cart-content.js"></script>
